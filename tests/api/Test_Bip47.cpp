...
TEST_F(Test_Bip47, test_shared_addresses)
{
    ...
    EXPECT_STREQ("12u3Uued2fuko2nY4SoSFGCoGLCBUGPkk6", OT::App().Crypto().BIP47().PubKeyAddress(A_Send_1, proto::CITEMTYPE_BTC).c_str());
    EXPECT_STREQ("12u3Uued2fuko2nY4SoSFGCoGLCBUGPkk6", OT::App().Crypto().BIP47().PubKeyAddress(B_Receive_1, proto::CITEMTYPE_BTC).c_str());
    
    EXPECT_STREQ("17SSoP6pwU1yq6fTATEQ7gLMDWiycm68VT", OT::App().Crypto().BIP47().PubKeyAddress(B_Send_0, proto::CITEMTYPE_BTC).c_str());
    EXPECT_STREQ("17SSoP6pwU1yq6fTATEQ7gLMDWiycm68VT", OT::App().Crypto().BIP47().PubKeyAddress(A_Receive_0, proto::CITEMTYPE_BTC).c_str());

    EXPECT_STREQ("1KNFAqYPoiy29rTQF44YT3v9tvRJYi15Xf", OT::App().Crypto().BIP47().PubKeyAddress(B_Send_1, proto::CITEMTYPE_BTC).c_str());
    EXPECT_STREQ("1KNFAqYPoiy29rTQF44YT3v9tvRJYi15Xf", OT::App().Crypto().BIP47().PubKeyAddress(A_Receive_1, proto::CITEMTYPE_BTC).c_str());           
}
